...
$authController->registerUser("Test Bruger", "testuser3@example.com", "password123");

echo "<h2>Test 2: Login med korrekt data</h2>";
$authController->loginUser("testuser2@example.com", "password1234");

echo "<h2>Test 3: Login med forkert data</h2>";
$authController->loginUser("testuser1@example.com", "wrongpassword");
