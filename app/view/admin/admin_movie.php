...
<div class="container">
        ...
        <?php foreach ($movies as $movie): ?>
            <div class="movie-item">
                ...
                <div class="movie-details">
                        ...
                        <form action="./index.php?page=admin_movie" method="post">
    ...
    <section id="create-movie">
        ...
        <form action="/page.php?page=admin_movie" method="post" enctype="multipart/form-data">
...
<select id="genres" name="genre_ids[]" class="select2-multiple" multiple>
  ...
  <section id="additional-forms">
        ...
        <form action="/page.php?page=admin_movie" method="post">
